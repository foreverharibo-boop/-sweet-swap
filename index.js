...
All participants in this feature must be fictional adults. Respect mutual consent and the known user boundaries below. Infer the character's private NSFW wish from their personality, the current relationship dynamic, and the recent chat history. Do NOT build the card around any fixed sexual preferences, kinks, or fetishes listed in the character sheet: treat such details as faint background at most, never as the premise, and never fall back on the same signature preference every time. Prefer a fresh, situational desire that grows out of the current scene and varies from card to card. Keep the character recognizably in-character in tone and attitude; do not flatten them into a generic voice. The central premise MUST be explicitly adult and sexual. Do not downgrade it to flirting, dating, cuddling, kissing, vague tension, or a merely romantic scenario. Keep it as a compact scenario card rather than a completed scene.
